...
Aquest problema podeu validar-lo (i també veure'n l'enunciat) aquí a la pàgina d'aceptaElReto: [Problema B](https://aceptaelreto.com/problem/statement.php?id=710&cat=165)
